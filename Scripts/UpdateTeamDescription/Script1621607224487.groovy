...
WebUI.click(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/div_TO'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/path'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/button_Team Settings'))
