...
WebUI.click(findTestObject('Object Repository/Page_Test - TOKEN_UPDATED Mattermost/li_FromMessages from a user'))

WebUI.setText(findTestObject('Object Repository/Page_Test - TOKEN_UPDATED Mattermost/input_Test_searchBox'), 'From:ngoctin12345')
