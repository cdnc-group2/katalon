...
WebUI.setText(findTestObject('Object Repository/Page_Test - TOKEN_UPDATED Mattermost/input_Test_searchBox'), '(^(^')

WebUI.sendKeys(findTestObject('Object Repository/Page_Test - TOKEN_UPDATED Mattermost/input_Test_searchBox'), Keys.chord(
        Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_Test - TOKEN_UPDATED Mattermost/i_Search Results_icon icon-close'))
