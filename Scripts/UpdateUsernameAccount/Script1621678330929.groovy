...
WebUI.click(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/button_ngoctin02806_style--none sidebar-hea_8af0e1'))
...
WebUI.setText(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/input_Username_username'), 'ngoctin12345')

WebUI.click(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/button_Save'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - TOKEN_UPDATED Mattermost/button_Close'))
