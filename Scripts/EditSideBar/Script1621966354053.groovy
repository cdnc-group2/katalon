...
WebUI.click(findTestObject('Edit SideBar/button_Sidebar'))

WebUI.click(findTestObject('Edit SideBar/button_Edit'))

WebUI.click(findTestObject('Edit SideBar/input_Off'))

WebUI.click(findTestObject('Edit SideBar/button_Save'))

WebUI.delay(1)

WebUI.click(findTestObject('Edit SideBar/button_Edit'))

WebUI.click(findTestObject('Edit SideBar/input_On'))
